...
const photos = [
  { src: '/gallery/the-blue-eye (1).jpg', alt: 'The Blue Eye Photo 1' },
  { src: '/gallery/the-blue-eye (2).jpg', alt: 'The Blue Eye Photo 2' },
  { src: '/gallery/the-blue-eye (3).jpg', alt: 'The Blue Eye Photo 3' },
  { src: '/gallery/the-blue-eye (4).jpg', alt: 'The Blue Eye Photo 4' },
  { src: '/gallery/the-blue-eye (5).jpg', alt: 'The Blue Eye Photo 5' },
  { src: '/gallery/the-blue-eye (6).jpg', alt: 'The Blue Eye Photo 6' },
  { src: '/gallery/the-blue-eye (7).jpg', alt: 'The Blue Eye Photo 7' },
  { src: '/gallery/the-blue-eye (8).jpg', alt: 'The Blue Eye Photo 8' },
  { src: '/gallery/the-blue-eye (9).jpg', alt: 'The Blue Eye Photo 9' },
